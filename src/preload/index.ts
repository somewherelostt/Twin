...
const bridge: TwinBridge = {
  ...
  beginWindowDrag: () => ipcRenderer.invoke("twin:begin-window-drag"),
  moveWindowDrag: () => ipcRenderer.invoke("twin:move-window-drag"),
  endWindowDrag: () => ipcRenderer.invoke("twin:end-window-drag"),
